...
def get_config():
    ...
    parser.add_argument("--top_k", type=int, default=50, help="top-k sampling for agent generation")
    parser.add_argument("--temperature", type=float, default=0.5, help="temperature for agent generation sampling")
    parser.add_argument("--do_sample", dest="do_sample", action="store_true", default=True, help="enable sampling for generation (default: True)")
    parser.add_argument("--no_do_sample", dest="do_sample", action="store_false", help="disable sampling for generation")
